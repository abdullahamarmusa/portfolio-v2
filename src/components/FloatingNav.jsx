    ...
    <div className={`fixed top-0 left-0 z-50 w-full transition-all duration-500 ease-out ${
      ...
      <nav className="flex items-center justify-between px-6 md:px-[100px] w-full max-w-[1440px] mx-auto relative z-50">
        ...
        <div className="flex-shrink-0 flex items-center justify-between w-full md:w-auto">
          <a href="#" className="text-xl md:text-2xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500 drop-shadow-sm leading-tight">
            Abdullah Amar Musa
          </a>
          <button 
      ...
      {/* Mobile Menu */}
      <div 
        className={`md:hidden fixed inset-0 z-40 bg-slate-950/95 backdrop-blur-2xl flex flex-col px-6 pt-24 pb-8 transition-opacity duration-300 ${
      ...
      >
        ...
        <a 
          ...
          className="w-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-bold py-4 rounded-xl mt-auto text-center block hover:opacity-90 transition-opacity"
        >
          Book Strategy Call
        </a>
      </div>
